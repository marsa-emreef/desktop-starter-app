package lib.component
{
	...
	public class IconGridItemRenderer extends GridItemRenderer
	{
		[Bindable]
		public var text:Label;
		
		[Bindable]
		public var iconVisible:Boolean;
		
		private var _icon:String;
		
		public function IconGridItemRenderer()
		{
			super();
			text = new Label();
			text.top = 0;
			...
			text.setStyle('fontFamily','Icon');
			text.setStyle('paddingTop',5);
			text.setStyle('paddingBottom',3);
			iconVisible = true;
			addElement(text);
			text.addEventListener(MouseEvent.CLICK,onClick);
			BindingUtils.bindProperty(text,'visible',this,'iconVisible');
		}
